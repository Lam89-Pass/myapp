        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white/90 backdrop-blur-xl p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 group">
                <div className="w-12 h-12 bg-emerald-50 rounded-full flex items-center justify-center text-emerald-500 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-400 mb-1">WhatsApp</p>
                  <a href="https://wa.me/6285603103375" target="_blank" rel="noreferrer" className="text-base font-bold text-slate-700 hover:text-emerald-500 transition-colors">
                    Chat via WhatsApp
                  </a>
                </div>
              </div>
